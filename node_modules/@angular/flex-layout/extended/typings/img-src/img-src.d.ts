...
export declare class ImgSrcDirective extends BaseDirective implements OnInit, OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ImgSrcDirective, [null, null, null, null, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<ImgSrcDirective, "  img[src.xs],    img[src.sm],    img[src.md],    img[src.lg],   img[src.xl],  img[src.lt-sm], img[src.lt-md], img[src.lt-lg], img[src.lt-xl],  img[src.gt-xs], img[src.gt-sm], img[src.gt-md], img[src.gt-lg]", never, { "srcBase": "src"; "srcXs": "src.xs"; "srcSm": "src.sm"; "srcMd": "src.md"; "srcLg": "src.lg"; "srcXl": "src.xl"; "srcLtSm": "src.lt-sm"; "srcLtMd": "src.lt-md"; "srcLtLg": "src.lt-lg"; "srcLtXl": "src.lt-xl"; "srcGtXs": "src.gt-xs"; "srcGtSm": "src.gt-sm"; "srcGtMd": "src.gt-md"; "srcGtLg": "src.gt-lg"; }, {}, never>;
}
